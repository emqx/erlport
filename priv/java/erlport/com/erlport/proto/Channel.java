...
import com.erlport.msg.PureMessage;
...
public class Channel {
    ...
    public void write(Message message) throws Exception {
        ...
        if (message instanceof PureMessage) {
            PureMessage pureMessage = new PureMessage();
            tuple = new Tuple(3);
            tuple.set(0, pureMessage.getType());
            tuple.set(1, pureMessage.getResult());
